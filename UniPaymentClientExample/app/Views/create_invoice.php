...
<head>
    ...
    <title>UniPayment Client Example | <?= esc($title) ?></title>
    <!-- Main CSS -->
            ...
            <div class="col-lg-8 offset-lg-2">
                ...
                <form method="POST" action="create-invoice">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10">
                            <select class="custom-select" name="payCurrency" id="payCurrency" required>
